<template>
  <div id="box_content">
      <Header closestate title="无面单查询"></Header>
    ...
    <div v-show="screeningpage" class="screen-content" @click.stop>
            ...
            <div class="home-cell">
              ...
              <div class="right_box">
                ...
                <div class="floatDiv" v-show="registernetDotshow" @click.stop>
                  <ul>
                    <li v-for="(item,index) in registernetDotSearchlist" @click.self.stop="checkedIndexNet(index,'reg')">{{item.fullName}}</li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="home-cell">
              ...
              <div class="right_box">
                ...
                <div class="floatDiv" v-show="claimNetDotshow" @click.stop>
                  <ul>
                    <li v-for="(item,index) in claimNetDotSearchlist" @click.self.stop="checkedIndexNet(index,'cal')">{{item.fullName}}</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div class="screen-bottom">
          ...
          <span @click="savestateSearchinfo" class="submitbtn">查询</span>
        </div>
      </div>
